...
present "NewRouter"         services/api/WARLOCK.md   "go: a func is declared"
present "CART_LIMIT"        web/src/WARLOCK.md        "typescript: an exported const is declared"
present "build_report"      tools/WARLOCK.md          "python: a def is declared"
present "REPORT_VERSION"    tools/WARLOCK.md          "python: a module const is declared"
present "Shelf"             tools/WARLOCK.md          "ruby: a class is declared"
present "Invoice"           services/WARLOCK.md       "java: a class is declared"
